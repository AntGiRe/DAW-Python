...
class Persona():
	...
	def es_mayor_que(self, persona):
		...
		elif ( self.edad < persona.getedad()):
	...
	def get_mayor(persona1, persona2):
		if (persona1.getedad() > persona2.get_edad()):
			return persona1
		elif (persona2.get_edad() > persona1.getedad()):
			return persona2
		else:
			return None
...
print(a.print_persona())
print(b.print_persona())
...
print("El mayor es:", Persona.get_mayor(a, b).print_persona())